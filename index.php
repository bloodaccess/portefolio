          ...
          <div id="skillbar" class="container">
              <div class="row">
                  ...
                  <div class="progress">
                      ...
                      <span class="progress-type">VB.NET</span>
                      <span class="progress-completed">60%</span>
                  </div>
                  </div>
                  <div class="col-sm-4">
                      <div class="progress">
                          <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
                              <span class="sr-only">60% Complete</span>
                          </div>
                          <span class="progress-type">Virtual machine</span>
